...
*/
block.prototype.go = function(step=1) {
	if(this.dir == 3 && this.pos[0]-step >= 0) this.pos[0] -= step;
	else if(this.dir == 1 && this.pos[0]+step <= 9) this.pos[0] += step;
	else if(this.dir == 0 && this.pos[1]-step >= 0) this.pos[1] -= step;
	else if(this.dir == 2 && this.pos[1]+step <= 9) this.pos[1] += step;
	else throw new Error("Unknown direction or unillegal step.");
};
/*
	@angle: string; define how to turn this block
			0 for left, 1 for right, 2 for back;
*/
...
block.prototype.render = function() {
	...
	$("#direction").setAttribute("class",dir[this.dir]);
};
var bl = new block();
